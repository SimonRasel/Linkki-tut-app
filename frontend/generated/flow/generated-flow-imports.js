...
import $cssFromFile_2 from 'Frontend/generated/jar-resources/styles/linkki-page.css?inline';

injectGlobalCss($cssFromFile_2.toString(), 'CSSImport end', document);
import $cssFromFile_3 from 'Frontend/generated/jar-resources/styles/linkki-tab-layout.css?inline';

injectGlobalCss($cssFromFile_3.toString(), 'CSSImport end', document);
import $cssFromFile_4 from 'Frontend/generated/jar-resources/styles/linkki-has-icon.css?inline';

injectGlobalCss($cssFromFile_4.toString(), 'CSSImport end', document);
import $cssFromFile_5 from 'Frontend/generated/jar-resources/styles/linkki-section.css?inline';
...
import $cssFromFile_8 from 'Frontend/generated/jar-resources/styles/linkki-dialog.css?inline';

injectGlobalCss($cssFromFile_8.toString(), 'CSSImport end', document);
import $cssFromFile_9 from 'Frontend/generated/jar-resources/styles/error-page.css?inline';

injectGlobalCss($cssFromFile_9.toString(), 'CSSImport end', document);
import $cssFromFile_10 from 'Frontend/generated/jar-resources/styles/linkki-notification.css?inline';
...
import 'Frontend/generated/jar-resources/src/linkki-tab-layout.ts';
import 'Frontend/generated/jar-resources/src/linkki-text.ts';
import 'Frontend/generated/jar-resources/src/linkki-section.ts';
